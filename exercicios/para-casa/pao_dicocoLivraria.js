...
class Livraria {
    constructor(nome) {
        ...
        this.livros = []
        /** Para criação de ambiente de pergunta e 
                ...
                this.prompt.question("Editora:", (respostaEditora) => {
                    ...
                    this.prompt.question("Ano Edição:", (respostaEdicao) => {
                        ...
                        this.prompt.question("Preço:", (respostaPreco) => {
                            ...
                            this.prompt.question("Gostaria de adicionar novo livro?: sim/não \n", (resposta) => {
                                if (resposta == 'sim') {
    ...
    apagarLivro() {
        this.prompt.question("Digite o título do livro que você deseja apagar: \n", (titulo) => {
            ...
            const tituloEncontrado = this.livros.find(livro => livro.titulo == titulo)
            if (!tituloEncontrado) {

                console.log("                                           ");
                console.log("Nenhum livro foi encontrado com este título");
                console.log("                                           ");
                return this.lidarSaida()
            }
    ...
    menu() {
        console.log("¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬");
        console.log(`Seja bem vindo à ${this.nome}`);
        console.log("¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬");
        ...
        this.prompt.question("Digite a opção desejada: \n", (resposta) => {
            ...
            switch (opcao) {
                ...
                case 0:
                    console.log('                                               ')
                    console.log("Ficamos felizes com sua presença. Volte sempre!")
                    console.log('                                               ')
                    this.prompt.close()
        ...
        this.prompt.question("Escolha uma das opções: \n", (resposta) => {
            ...
            switch (alternativa) {
                ...
                case 2:
                    ...
                    break;
                default:
                    console.log(`A opção ${alternativa} não é valida, tente novamente!`)
                    this.lidarSaida()
                    break;
            }
        })
...
const novaLoja = new Livraria("Pão Dicôco Livraria")
novaLoja.menu()